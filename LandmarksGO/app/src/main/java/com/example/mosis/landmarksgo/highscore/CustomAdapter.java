...
public class CustomAdapter extends ArrayAdapter<DataModel> implements View.OnClickListener{
    ...
    public CustomAdapter(ArrayList<DataModel> data, Context context) {
        super(context, R.layout.user, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.tvName = (TextView) convertView.findViewById(R.id.textViewUserName);
            viewHolder.tvPoints = (TextView) convertView.findViewById(R.id.textViewUserPoints);
            viewHolder.imPhoto = (ImageView) convertView.findViewById(R.id.imageViewUserPhoto);
            viewHolder.tvNumber = (TextView) convertView.findViewById(R.id.textViewNumber);
            //result=convertView;
        ...
        viewHolder.imPhoto.setImageDrawable(dataModel.getPhoto());
